...
while($registro = mysqli_fetch_assoc($noticia))
{
	...
	echo "<div class='titulo'><h1>" . $registro['titulo'] . "</h1><div class='contato'><span>Autor: " . $nome . "</span><br/><span>Email: " . $email . "</span></div></div>";
	
	echo "<div class='bloco'><hr/><p>" . $registro['texto'] . "</p><hr/><div class='bot'><button><a  class='BtPadraoAnima' href='index.php'>Voltar</a></button></div></div>";
